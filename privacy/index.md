...
<div class="legal-note" markdown="1">
**EU/UK Representative (Article 27 GDPR / Article 27 UK GDPR).** SmileyCreative LLC has not yet engaged a designated EU and UK representative under Article 27 of the GDPR / UK GDPR. **<span style="color:#c2410c"><strong>TODO (Greg):</strong> appoint an Article 27 representative — e.g., Prighter, EU-Rep.eu, or comparable provider (~€100–200 / yr) — before active EU/UK marketing or paid acquisition.</span>** Once appointed, the representative's name, postal address, and contact email will be inserted here. Until then, EU/UK residents may contact the Company directly at **milely@smileycreative.io** and we will respond within GDPR's standard one-month window.
</div>
